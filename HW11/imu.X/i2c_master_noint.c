...
void i2c_master_setup(void) {
    ...
    I2C1BRG = 5; // I2CBRG = [1/(2*Fsck) - TPGD]*Pblck - 2 (TPGD is the Pulse Gobbler Delay)
...
void write(unsigned char r, unsigned char value){
    i2c_master_start();
...
unsigned char read(unsigned char r){
    ...
    i2c_master_send(r);//where im reading from
